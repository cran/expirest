...
test_that("print_and_thus_summary.expirest_osle_succeeds", {
  re1 <-
...
test_that("print_and_plot.plot_expirest_osle_succeeds", {
  re1 <-
    expirest_osle(
  ...
  ggre1_1 <-
    plot_expirest_osle(
      ...
      x_range = NULL, y_range = c(-0.01, 0.5), plot_option = "full",
      ci_app = "line")
...
test_that("print_and_thus_summary.expirest_wisle_succeeds", {
  ...
  expect_output(print(re1, digits = 5), "2    NA    2.4568")
  ...
  expect_output(print(re2, digits = 5), "98    b8    101.26")
  expect_output(print(re2, digits = 5),
...
test_that("print_and_plot.plot_expirest_wisle_succeeds", {
  re1 <-
    expirest_wisle(
      data = exp2, response_vbl = "Related", time_vbl = "Month",
  ...
  ggre1_1 <-
    plot_expirest_wisle(
      ...
      response_vbl_unit = "%", x_range = NULL, y_range = c(-0.01, 0.50),
